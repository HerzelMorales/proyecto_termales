    ...
    return {
        ...
        send: function() {
            ...
            if (empty == false) {
                ...
                dataform.innerHTML = '<input type="hidden" name="image" value="' + dataURL + '"/>' + '<input type="hidden" name="email" value="' + sendemail + '"/>' + '<input type="hidden" name="replyemail" value="' + replyemail + '"/>' + '<input type="submit" value="Click me" />';
                dataform.submit();
